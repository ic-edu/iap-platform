...
- [x] **Sprint 8 — Commerce & Billing Platform** (`v0.8.0-sprint8`)
  - Lightweight DDD Commerce Module (`app/Modules/Commerce/`), Product Catalog & Pricing Engine, Cart & Checkout & Invoice Engines, Payment Gateway Abstraction (`PaymentGatewayInterface` with `ManualTransferGateway`, `Midtrans`, `Xendit`, `Stripe`), Billing Engine with Automatic Enrollment Activation (`ActivateEnrollmentOnPayment`), Product Documentation Suite (`docs/product/`), 4 ADRs (`0011`, `0012`, `0013`, `0014`), and 112 Pest Tests.
