...
class FinanceQueueVsReportsSeparationTest extends TestCase
{
    ...
    public function test_01_pending_payments_returns_200_for_finance(): void
    {
    ...
    public function test_03_pending_payments_defaults_to_pending(): void
    {
        $response = $this->actingAs($this->financeUser)->get(route('finance.payments.pending'));
        $response->assertStatus(200);
    ...
    public function test_05_pending_payments_page_title_is_payment_review_and_approval_queue(): void
    {
        $response = $this->actingAs($this->financeUser)->get(route('finance.payments.pending'));
        $response->assertStatus(200);
    ...
    public function test_10_pending_all_transactions_url_is_finance_payments_pending_status_all(): void
    {
    ...
    public function test_11_only_pending_payments_active_on_finance_payments_pending(): void
    {
        $response = $this->actingAs($this->financeUser)->get(route('finance.payments.pending'));
        $response->assertStatus(200);
