...
@section('content')
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        ...
        <div class="p-5 bg-slate-900 border border-slate-800 rounded-xl">
            ...
            <span class="text-3xl font-black text-indigo-600 dark:text-indigo-400 mt-1 block">{{ $publishedQuestionBanksCount }}</span>
        ...
        <div class="p-5 bg-slate-900 border border-slate-800 rounded-xl">
            ...
            <span class="text-3xl font-black text-emerald-600 dark:text-emerald-400 mt-1 block">{{ $publishedTestsCount }}</span>
        ...
        <div class="p-5 bg-slate-900 border border-slate-800 rounded-xl">
            ...
            <span class="text-3xl font-black text-amber-600 dark:text-amber-400 mt-1 block">{{ $pendingApprovalsCount }}</span>
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-sm">
        <div class="p-4 border-b border-slate-800 flex items-center justify-between">
            ...
            <a href="{{ route('admin.users.index') }}" class="text-xs text-indigo-600 dark:text-indigo-400 font-semibold hover:underline">View All Users →</a>
        </div>
            ...
            <tbody class="divide-y divide-slate-800/60 font-mono text-xs">
                @foreach ($recentUsers as $user)
                    <tr>
                        ...
                        <td class="p-4">
                            <x-role-badge :role="$user->roles->first()?->name ?? 'student'" />
                        </td>
