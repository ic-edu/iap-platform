...
@section('content')
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-400 mt-1">Review and authorize archived Question Bank restoration requests submitted for Super Admin approval.</p>
        </div>
        <div>
            ...
            <tbody class="divide-y divide-slate-800/60">
                @forelse ($pendingRestorationRequests as $bank)
                    <tr>
                        ...
                        <td class="p-4 text-xs font-bold text-amber-400 uppercase">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="p-12 text-center">
                            ...
                            <div class="text-sm font-bold text-white mb-1">No Pending Restoration Requests</div>
                            <div class="text-xs text-slate-500">All restoration requests have been processed.</div>
                        </td>
                    </tr>
                @endforelse
            </tbody>
