...
@section('content')
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-400 mt-1">Review, authorize, and approve assessment test submissions for institutional publication.</p>
        </div>
        <div>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="p-12 text-center">
                            ...
                            <div class="text-sm font-bold text-white mb-1">No Pending Assessment Submissions</div>
                            <div class="text-xs text-slate-500">All submitted assessment tests have been reviewed and authorized.</div>
                        </td>
                    </tr>
                @endforelse
            </tbody>
