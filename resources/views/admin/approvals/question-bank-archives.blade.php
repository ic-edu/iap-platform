...
@section('content')
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-400 mt-1">Review pending question bank archive requests submitted by Operational Administrators.</p>
        </div>
        <div>
            <span class="px-3 py-1.5 text-xs font-bold rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="p-12 text-center">
                            ...
                            <div class="text-sm font-bold text-white mb-1">No Pending Archive Requests</div>
                            <div class="text-xs text-slate-500">All question bank archive requests have been processed.</div>
                        </td>
                    </tr>
                @endforelse
            </tbody>
